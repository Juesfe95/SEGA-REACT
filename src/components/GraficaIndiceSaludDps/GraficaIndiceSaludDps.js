...
export default function GraficoTortaCriticidadTrafos(props) {
  ...
  const url = 'http://10.240.238.94:8080/epsa-api/api/transformador/dashboard-tortas-descargadores-' + props.zona;
  ...
  const fillChart = () => {
    if (myChart.current) {
      am4core.ready(function () {
        ...
        var chart = am4core.create("chartdiv-descargador", am4charts.PieChart);
        ...
        pieSeries.legendSettings.fontSize = 10;
